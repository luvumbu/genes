...
var redirection = new Url_page_class(window_location_href ,50000); 
...
function displayHello() {
 ...
 if(y<taille){
  ...
  console.log(get_result_users_nom_1_array_2[y]);
  console.log(get_users_naissance_array_2[y]);



  var ok = new Information("https://bokonzi.com/genes/php.php"); // création de la classe 



  if(get_rp_array_2[y]!=undefined  ){
  

  
 if(get_users_nom_complet_array[y]!=""){
  var source ="https://bokonzi.com/genes/src_1.php/index.php/"+get_users_nom_complet_array[y][0] ; 
  var includes_= false; 
  var get_code_result = get_users_nom_complet_array[y]+get_result_date_perf_array_2[y]+get_result_users_perf_array_2[y];
  console.log(includes_); 
   
    ok.add("get_rp_array_2", get_rp_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_vent_array_2", get_vent_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_result_users_perf_array_2", get_result_users_perf_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_result_users_nom_1_array_2", get_result_users_nom_1_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_result_users_nom_2_array_2", get_result_users_nom_2_array_2[y]); // ajout d'une deuxieme information denvoi  
    ok.add("get_result_users_nom_3_array_2", get_result_users_nom_3_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_result_users_nom_4_array_2", get_result_users_nom_4_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_users_nationality_array_2", get_users_nationality_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_club_nom_complet_array_2", get_club_nom_complet_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_club_departement_array_2", get_club_departement_array_2[y]); // ajout d'une deuxieme information denvoi  
    ok.add("get_club_region_array_2", get_club_region_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_cat_array_2", get_cat_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_users_naissance_array_2", get_users_naissance_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_result_date_perf_array_2", get_result_date_perf_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("get_result_villes_nom_array_2", get_result_villes_nom_array_2[y]); // ajout d'une deuxieme information denvoi
    ok.add("window_location_href", window.location.href); // ajout d'une deuxieme information denvoi
    ok.add("epreuve_sex_array_2", epreuve_sex_array_2); // ajout d'une deuxieme information denvoi
    ok.add("get_users_nom_complet_array", get_users_nom_complet_array[y]); // ajout d'une deuxieme information denvoi
    ok.add("lettre", get_users_nom_complet_array[y][0]); // ajout d'une deuxieme information denvoi
    ok.add("get_epreuve_nom_complet",get_epreuve_nom_complet ); // ajout d'une deuxieme information denvoi
    ok.add("get_code_result", get_code_result); // ajout d'une deuxieme information denvoi
    console.log(ok.info()); // demande l'information dans le tableau
    ok.push(); // envoie l'information au code pkp    
 

    
var source ="https://bokonzi.com/genes/php.php" ; 
